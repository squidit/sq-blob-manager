...
ClientManager.MESSAGE = {
  CLIENT_QUERY_FAILED: 'Não foi possível recuperar o registro do cliente.',
  NO_CLIENT_FOR_CLIENT_KEY: 'Nenhum dado encontrado para o parâmetro clientKey informado.',
  CONTAINER_QUERY_FAILED: 'Não foi possível recuperar os registros dos containers do cliente.',
  NO_CONTAINER_FOR_CLIENT_ID: 'Nenhum dado encontrado para o parâmetro clientID informado.',
};
  ...
  self._tableSvc.queryEntities(
    ...
    options, (error, result, response) => {
      ...
      self.getContainersInfo(repositoryInfo.clientID, options, (errContainer, containerInfo) => {
        ...
        return callback(err, repositoryInfo);
      });
...
ClientManager.prototype.getContainersInfo = function (clientID, optionsOrCallback, cb) {
  ...
  self._tableSvc.queryEntities(
    ...
    options, (error, result, response) => {
      ...
      return callback(err, containersInfo);
    });
};
