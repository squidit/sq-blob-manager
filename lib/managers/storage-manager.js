  ...
  self._clientManager.getRepositoryInfo(options, (error, info) => {
    ...
    self._blobSvc.createBlockBlobFromStream(
      ...
      options, (uploadError, uploadResult, uploadResponse) => {
        ...
        const cdnFileUrl = `https://${AZURE_STORAGE_ACCOUNT}.azureedge.net/${containerInfo.mediaStore}/${fileName}`;
        const fileUrl = `https://${AZURE_STORAGE_ACCOUNT}.blob.core.windows.net/${containerInfo.mediaStore}/${fileName}`;
